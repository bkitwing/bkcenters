...
const CenterCard: React.FC<CenterCardProps> = ({ 
  ...
  return (
    <div className="card hover:shadow-md transition-shadow border border-neutral-200 p-4 rounded-lg">
      ...
      {expanded && (
        <div className="mt-3 space-y-2 text-sm border-t border-neutral-100 pt-3">
          {center.contact && (
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        >
          ...
          {showShareTooltip && (
            <span className="absolute bottom-full left-0 mb-2 bg-dark text-light text-xs py-1 px-2 rounded pointer-events-none whitespace-nowrap">
              Copied to clipboard!
            </span>
          )}
        </button>
